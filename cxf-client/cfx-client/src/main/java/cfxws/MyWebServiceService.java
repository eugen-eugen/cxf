 ...
 * 
 */
@WebServiceClient(name = "MyWebServiceService", targetNamespace = "http://cfxws/", wsdlLocation = "file:/C:/Projekte/ITZ_Bund/initi/ws/cfx/src/main/resources/MyWebService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICESERVICE_QNAME = new QName("http://cfxws/", "MyWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Projekte/ITZ_Bund/initi/ws/cfx/src/main/resources/MyWebService.wsdl");
    ...
    public MyWebService getMyWebServicePort() {
        return super.getPort(new QName("http://cfxws/", "MyWebServicePort"), MyWebService.class);
    }
    ...
    public MyWebService getMyWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cfxws/", "MyWebServicePort"), MyWebService.class, features);
    }
